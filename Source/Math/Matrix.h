...
public:
	...
	static Matrix4x4 GeneratePerspective(const float& angle, const float& aspect, const float& near, const float& far)
	{
		return glm::perspective(angle, aspect, near, far);
	}
